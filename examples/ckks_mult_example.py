...
def main():
    ...
    # Create messages using NumPy arrays
    message1 = np.array([0.5, 0.3 + 0.2j, 0.78, 0.88j], dtype=complex)
    message2 = np.array([0.2, 0.11, 0.4 + 0.67j, 0.9 + 0.99j], dtype=complex)
    
    plain1 = encoder.encode(message1.tolist(), scaling_factor)
    plain2 = encoder.encode(message2.tolist(), scaling_factor)
